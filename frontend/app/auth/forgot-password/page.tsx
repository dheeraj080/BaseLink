...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="min-h-screen flex bg-onyx overflow-hidden">
      {/* Left Side: Art/Visuals (Same as Login/Register for consistency) */}
        ...
        <div className="relative z-10 p-16 max-w-xl">
          ...
          >
            ...
            <h1 className="text-6xl font-bold text-soft-linen leading-[0.9] tracking-tighter mb-8 text-shadow-xl ">
              RECOVER <br/>
              <span className="text-silver italic font-serif">access.</span>
            </h1>
            
            <p className="text-lg text-silver font-medium leading-relaxed mb-12 max-w-md">
              Securely reset your credentials and regain control of your enterprise communication hub.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-[40%] flex items-center justify-center p-8 bg-onyx px-4 py-12 relative overflow-hidden">
        ...
        >
          <div className="mb-10 text-center lg:text-left">
            <h2 className="text-4xl font-bold text-soft-linen tracking-tight leading-tight">Reset Password</h2>
            <p className="text-silver font-medium mt-3">Enter your email to receive a 6-digit recovery code</p>
          </div>
            ...
            {isSuccess ? (
              <div className="text-center space-y-6 py-4">
                <div className="flex justify-center">
                  <div className="w-16 h-16 bg-soft-linen/10 rounded-full flex items-center justify-center border border-soft-linen/20">
                    <CheckCircle2 className="w-8 h-8 text-soft-linen" />
                  </div>
                </div>
                <div>
                ...
                <Link
                  ...
                  className="w-full bg-soft-linen hover:bg-white-smoke text-onyx rounded-xl py-3.5 font-bold uppercase tracking-wider text-xs flex items-center justify-center gap-2 shadow-lg transition-all"
                >
                  Enter Recovery Code
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-soft-linen hover:bg-white-smoke text-onyx rounded-xl py-3.5 font-bold uppercase tracking-wider text-xs flex items-center justify-center gap-2 shadow-lg transition-all disabled:opacity-50 active:scale-[0.99]"
                >
                  {isSubmitting ? <Loader2 className="w-5 h-5 animate-spin" /> : <>Send Code <ArrowRight className="w-4 h-4" /></>}
                </button>
