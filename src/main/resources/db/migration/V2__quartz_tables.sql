...
CREATE INDEX idx_qrtz_ft_trig_inst ON qrtz_fired_triggers (sched_name, instance_name);
CREATE INDEX idx_qrtz_ft_inst_job ON qrtz_fired_triggers (sched_name, instance_name, requests_recovery);
